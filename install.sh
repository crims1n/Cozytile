...
# Install packages
paru -Syu base-devel qtile python-psutil pywal-git feh picom-jonaburg-fix dunst zsh playerctl brightnessctl kitty pfetch thunar rofi ranger pipewire pipewire-alsa wireplumber pipewire-pulse neovim vim git sddm alsa-utils --noconfirm --needed
